<div class="d-flex justify-content-center flex-column align-items-center">
    <div class="container-fluid" style='width:94%'>
        <form action="#" id='record'>
            <label for="hour" class="form-label">Оценка/Зачет/Не аттестован</label>
            <input type="text" id="record_value" name = 'value' class="form-control" aria-describedby="recordhelp" placeholder='Значение'>
        ...
        <div class="container-fluid">
            <h2>Список аттестаций <span id="groupnamerecord">Имя группы</span></h2>
        </div>
        <div class="container-fluid ">
            ...
            <ul class="list-group container-fluid" id = 'recordstable'>
